...
public interface BaseRedis<K, V> {
     ...
     * @return
     */
    Set<V> getSetDifference(K key, K otherKey);
    ...
    /**
     *@Author wuxubiao
     *@Description 通过管道批量提交set数据
     *@Date 2018/12/5 15:55
     *@Param [key, list]
     *@return void
     **/
    void setPipelined(String key, List<String> list);

    void stringPipelined(Map<String, String> map);
