package com.ynzyq.yudbadmin.redis;
...
@Service
@Slf4j
public class RedisUtils implements BaseRedis<String, Object> {
    ...
    public Set<Object> getSetDifference(String key, String otherKey) {
        return redisTemplate.boundSetOps(key).diff(otherKey);
    }

    @Override
    public void setPipelined(String key, List<String> list) {
        ...
        redisTemplate.executePipelined(new RedisCallback<String>() {
            ...
            public String doInRedis(RedisConnection redisConnection) throws DataAccessException {
                ...
                for (int i = 0; i < count; i++) {
                    redisConnection.sAdd(key.getBytes(), list.get(i).getBytes());
                }
                return null;
            }
        });
    ...
    @Override
    public void stringPipelined(Map<String, String> map) {
        ...
        redisTemplate.executePipelined(new RedisCallback<String>() {
            ...
            public String doInRedis(RedisConnection redisConnection) throws DataAccessException {
                ...
                for (Map.Entry<String, String> entry : map.entrySet()) {
                    redisConnection.set(entry.getKey().getBytes(), entry.getValue().getBytes());
                }
                return null;
            }
        });
    ...
    public String token(HttpServletRequest httpServletRequest) {
        ...
        String vlaue = (String) redisTemplate.boundValueOps(token).get();
        try {
            vlaue = Encrypt.AESdecrypt(vlaue);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return vlaue;
