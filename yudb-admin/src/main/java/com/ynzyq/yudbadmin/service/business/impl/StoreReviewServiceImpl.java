...
public class StoreReviewServiceImpl implements StoreReviewService {
    ...
    @Override
    public ApiRes<PageWrap<StoreReviewPageVo>> findPage(PageWrap<StoreReviewPageDto> pageWrap) {
        ...
        List<StoreReviewPageVo> storeReviewPageVos = merchantStoreExamineMapper.storeReviewPageVos(storeReviewPageDto);
        storeReviewPageVos.stream().forEach(
                storeReviewPageVo -> {
        ...
        return ApiRes.response(CommonConstant.SUCCESS_CODE, "查询成功", PageData.from(new PageInfo<>(storeReviewPageVos)));
    }

    @Override
    public ApiRes<StoreReviewDetailVo> detail(StoreReviewDetailDto storeReviewDetailDto) {
        ...
        StoreReviewDetailVo storeReviewDetailVo = new StoreReviewDetailVo();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        storeReviewDetailVo.setUid(merchantStoreExamine.getMerchantStoreUid());
        storeReviewDetailVo.setOldTime(sdf.format(merchantStoreExamine.getOldTime()));
        storeReviewDetailVo.setNewTime(sdf.format(merchantStoreExamine.getNewTime()));
        storeReviewDetailVo.setManagementExpense(merchantStoreExamine.getManagementExpense() + "");
        ...
        storeReviewDetailVo.setExamineDetailVoList(examineDetailVoList);
...
//        );
        ...
        storeReviewDetailVo.setExamineFileVoList(examineFileVoList);
        return ApiRes.response(CommonConstant.SUCCESS_CODE, "查询成功", storeReviewDetailVo);
    }
