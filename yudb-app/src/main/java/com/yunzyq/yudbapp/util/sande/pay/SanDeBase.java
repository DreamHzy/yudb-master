...
import com.yunzyq.yudbapp.util.sande.*;
 ...
 */
public class SanDeBase {


    private static String url = "https://cashier.sandpay.com.cn/gateway/api";

    public static Logger logger = LoggerFactory.getLogger(SanDeBase.class);
    ...
    public static JSONObject requestServer(JSONObject header, JSONObject body, String reqAddr) {
        ...
        try {
            ...
            result = HttpClient.doPost(url + reqAddr, reqMap, connectTimeout, readTimeout);
            logger.info("响应报文：\n" + result);
